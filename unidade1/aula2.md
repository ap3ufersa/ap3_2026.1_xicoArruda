### U1 - Aula 2 - 13/03/2026 (1,0) - Configuração do ambiente, olá mundo, tipos primitivos
...
4. Crie um novo repositório no formato **ap3_2026.1_primeironomeSegundonome** (ex.: ap3_2026.1_mariaSilva). Deixe privado.
5. Altere o arquivo README.md localmente com informações sobre o repositório (dicas [aqui](https://gist.github.com/lohhans/f8da0b147550df3f96914d3797e9fb89)).
...
1. Instale o [JDK](https://adoptium.net/temurin/releases/) (Windows | x64 | JDK | 25 - LTS | arquivo .msi), marcando [as opções](https://drive.google.com/open?id=1BMqLvV0vZPz728qvQq2JVdf9McBGN9PY) e [liberando o firewall](https://drive.google.com/open?id=1BTl2hp2ZlEhAVqhpDfMOC0SY4ztLtMzs) caso necessário.
...
### Considerações sobre OO e tipos primitivos:
